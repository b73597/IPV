                            ...
                            public void done(ParseException e) {
                                if (e == null) {
                                    ...
                                    if(e.getCode() == ParseException.USERNAME_TAKEN){
                                        ...
                                        //Toast.makeText(getApplicationContext(), "Invalid information, please try again!", Toast.LENGTH_SHORT).show();
                                        // pop alert wrong info user
                                        mEmailView.setError(getString(R.string.error_wrong_info));
                                        mEmailView.requestFocus();
                                        // pop alert wrong info password
                                        mPasswordView.setError(getString(R.string.error_wrong_info));
                                        mPasswordView.requestFocus();
